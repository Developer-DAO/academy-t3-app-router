...
interface DDIcons {
  ...
  info: (props: LucideProps) => JSX.Element;
...
export const Icons: DDIcons = {
  ...
  moon_light: (props: LucideProps) => (
    ...
    >
      <path
        d="M22.6689 14.0274C22.5937 13.9522 22.4994 13.899 22.3961 13.8733C22.2929 13.8477 22.1847 13.8506 22.083 13.8819C20.5595 14.3423 18.9397 14.3808 17.3961 13.9932C15.8525 13.6056 14.4429 12.8065 13.3177 11.6809C12.1925 10.5554 11.3937 9.14568 11.0065 7.60196C10.6193 6.05824 10.6583 4.4384 11.1191 2.91506C11.1499 2.81348 11.1525 2.70544 11.1267 2.60248C11.1009 2.49953 11.0475 2.40553 10.9724 2.33052C10.8973 2.25551 10.8032 2.20232 10.7003 2.17662C10.5973 2.15091 10.4892 2.15367 10.3877 2.18459C8.36772 2.80431 6.59455 4.04509 5.3203 5.73049C3.87583 7.64855 3.17282 10.0238 3.34066 12.4191C3.50851 14.8143 4.53593 17.0684 6.23379 18.7662C7.93165 20.4641 10.1857 21.4915 12.5809 21.6593C14.9762 21.8272 17.3515 21.1242 19.2695 19.6797C20.9549 18.4055 22.1957 16.6323 22.8154 14.6123C22.8463 14.5107 22.849 14.4026 22.8232 14.2996C22.7974 14.1965 22.7441 14.1024 22.6689 14.0274ZM18.5674 18.7432C16.8748 20.0126 14.7812 20.6289 12.6709 20.4789C10.5605 20.3289 8.57513 19.4227 7.07913 17.9267C5.58313 16.4307 4.67696 14.4453 4.52698 12.335C4.37701 10.2246 4.99329 8.13103 6.26268 6.4385C7.16683 5.23969 8.3603 4.28982 9.73143 3.67776C9.44277 5.26333 9.5429 6.89525 10.0233 8.43363C10.5036 9.97201 11.3499 11.371 12.4895 12.5106C13.6291 13.6501 15.028 14.4964 16.5664 14.9768C18.1048 15.4571 19.7367 15.5572 21.3223 15.2686C20.7119 16.6415 19.763 17.837 18.5644 18.7432H18.5674Z"
        fill="white"
      />
    </svg>
  ),
  more_horizontal: (props: LucideProps) => <MoreHorizontalIcon {...props} />,
};

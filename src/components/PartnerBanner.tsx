  ...
  return (
    <div className=" banner  !border-none !bg-opacity-10 !bg-gradient-to-tr from-stone-700 from-10% via-black via-60% to-[#727171]  to-90% !p-[2px] md:flex-col lg:flex-row">
      <Card className=" banner !md:flex-col !border-none !bg-black !bg-opacity-90  lg:flex-row">
        <div className=" flex flex-col-reverse items-center justify-center p-[40px] md:w-[78rem] md:flex-row md:p-0">
          <div className="mb-8 md:mb-0 md:py-[25px] md:pl-[30px] md:pr-[200px]">
            ...
            <CardContent className=" p-1 pb-12 text-center text-[13px] font-light text-white md:mb-[40px] md:pb-1 md:text-[17px]">
              <p>
                DeveloperDAO is a community of thousands of web3 <br /> builders
                creating a better internet. Join us and help <br /> educate the

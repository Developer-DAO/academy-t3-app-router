import CliLesson from "../../../fundamentals/cli_lesson/cli_lesson.mdx";
import InstallNpm from "../../../fundamentals/install-npm/install-npm.mdx";
import OpenZeppelin from "../../../fundamentals/open_zeppelin/open_zeppelin.mdx";
import TokenStandards from "../../../fundamentals/token-standards/token-standards.mdx";
import DecentralizedStorage from "../../../fundamentals/decentralized-storage/decentralized-storage.mdx";
...
<LessonLayout
   ...
   lessonDescription="Crafting a Basic NFT: A Step-by-Step ERC-721 Tutorial for Beginners."
   author="7i7o, piablo"
...
Let's also make the learning enjoyable by taking care of our well-being. Take
...
what's to come:
{/* First, did you set your pomodoro? ⌛😊 */}
...
How did you find that? No worries if the answers didn't come easily. We're here
to fill in the gaps!{" "}
...
<LessonInformationalModal
  title=" "
  buttonText="How to install NPM on your system"
>
  <InstallNpm />
</LessonInformationalModal>
...
<LessonInformationalModal buttonText="What on Earth is Hardhat?" title="What on Earth is Hardhat?">
...
<LessonInformationalModal buttonText="More on Open Zeppelin" title="">
  <OpenZeppelin />
</LessonInformationalModal>
...
<LessonInformationalModal title=" " buttonText="More about Token Standards">
  <TokenStandards />
</LessonInformationalModal>
...
<LessonInformationalModal buttonText="Longer Path (learn about JSON and IPFS)" title="Longer Path (learn about JSON and IPFS)">
## JSON
Go touch grass 😊 🌱
...
<LessonInformationalModal
  buttonText="More on Decentralized Storage"
  title="&nbsp;"
>
...
location-based, IPFS addresses a file by _what's in it_, i.e. its content. The
content identifier is a _unique cryptographic hash_ of the content at that
address.
...
<LessonQuestionsModal buttonText="Checkpoint Questions" title="Web3 File Storage and Good Practices">
...
to clipboard for use. Remember to never disclose this key! Now we can
paste it in to our `hardhat.config.js`
...
<br />
<QuizStatusChecker quiz="nft-solidity/quiz-nft-solidity-2" />
<br />

...
<div className="text-center">*Figure 1: The blockweave*</div>

<Callout emoji="💡">
  Note: In this course, the term *transaction body* will be used to avoid
  confusing it with the other transaction data (e.g., signature, address, tags,
  etc.)
</Callout>
...
<div className="text-center">*Figure 2: Arweave & AR.IO*</div>
...
<div className="text-center">*Figure 3: Chunk selection*</div>
...
<div className="text-center">*Figure 4: Arweave transaction types*</div>

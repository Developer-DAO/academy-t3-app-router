...
const MyProfile = () => {
  ...
  return (
    <div className=" flex flex-col  md:mx-[90px] md:mt-[120px]">
      ...
      <div className=" flex  md:gap-x-[300px]">
        <div>
          ...
          <ProfileComponentContainer style="font-bold flex flex-col gap-y-[44px] md:mb-[225px]">
        ...
        <div className=" flex flex-col items-center gap-y-[50px] md:mt-[100px]">
          <p className=" text-center font-poppins text-[48px] font-bold text-white">
            Looks like you haven’t <br /> started a track yet
          </p>
          <Button
            onClick={() => router.push("/tracks")}
            className={`connect-button !px-7 !py-3 font-future hover:bg-[var(--button-secondary-dark)]`}
          >
            Get Started
          </Button>
        </div>

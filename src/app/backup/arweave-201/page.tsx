...
//       description="Go from 0 to building on Arweave. Learn what Arweave is, how to access and store data on Arweave, and how to build permaweb apps and deploy them to Arweave."
//       openGraph={{
//         images: [
//           {
//             url:

...
<LessonLayout
   ...
   lessonDescription="Beginner-friendly. Create your first Solidity smart contract and learn the fundamentals of blockchain development. Checkpoint quizzes included."
   author="7i7o, piablo"
...
ideas. Remember your well-being and
...
<LessonQuestionsModal buttonText="Warm-up Questions" title="Warm-up Questions">
...
<LessonInformationalModal buttonText="What is a Blockchain?" title="What is a Blockchain?">
...
<LessonInformationalModal buttonText="What is a Smart Contract?" title="What is a Smart Contract?">
...
<LessonInformationalModal buttonText="Integrated Development Environment" title="Integrated Development Environment">
...
<LessonInformationalModal buttonText="More on Variables and Types" title="More on Variables and Types">
...
<LessonInformationalModal buttonText="More on Functions" title="More on Functions">
...
<LessonInformationalModal buttonText="Indexed Event Parameters" title="Indexed Event Parameters">
...
<LessonInformationalModal buttonText="More on Events" title="More on Events">
...
<LessonInformationalModal buttonText="Problems at Compile Time?" title="Problems at Compile Time?">
...
<br />
<br />
<QuizStatusChecker quiz="nft-solidity/quiz-nft-solidity-1" />
<br />
<br />
